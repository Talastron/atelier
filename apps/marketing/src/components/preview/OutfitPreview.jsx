...
const OUTFITS = [
  {
    ...
    items: [
      { slot: 'Top', name: 'Champagne silk vest', image: '/wardrobe/gene-silk-front-vest-top-in-champagne-si.jpg' },
      { slot: 'Bottom', name: 'Wool-blend trousers', image: '/wardrobe/gael-wool-blend-trousers.jpg' },
      { slot: 'Footwear', name: 'Block-heel sandals', image: '/wardrobe/suedette-2-part-block-heel-sandals.jpg' },
      { slot: 'Accessory', name: 'Fine chain necklace', image: '/wardrobe/fine-chain-necklace-24-monica-vinader.jpg' },
    ],
  ...
  },
  {
    ...
    items: [
      { slot: 'Dress', name: 'Pleat-detail dress', image: '/wardrobe/claire-pleat-detail-dress.jpg' },
      { slot: 'Outerwear', name: 'Navy wool coat', image: '/wardrobe/jasmin-coat.jpg' },
      { slot: 'Footwear', name: 'Gold block-heel sandals', image: '/wardrobe/merisa-gold-wide-fit-block-heel-sandals-.jpg' },
      { slot: 'Accessory', name: 'Gold stick necklace', image: '/wardrobe/y-sparks-stick-gold-necklace.jpg' },
    ],
  ...
  },
  {
    ...
    items: [
      { slot: 'Top', name: 'Silk colourblock vest', image: '/wardrobe/pippa-silk-front-colourblock-vest.jpg' },
      { slot: 'Bottom', name: 'High-rise denim shorts', image: '/wardrobe/high-rise-denim-shorts.jpg' },
      { slot: 'Footwear', name: 'Block-heel sandals', image: '/wardrobe/suedette-2-part-block-heel-sandals.jpg' },
      { slot: 'Accessory', name: 'Fine chain necklace', image: '/wardrobe/fine-chain-necklace-24-monica-vinader.jpg' },
    ],
