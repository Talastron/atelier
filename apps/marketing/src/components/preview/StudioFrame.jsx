...
const SAMPLE_ITEMS = [
  { src: '/seed-wardrobe/camel-wool-coat.jpg',           name: 'Belted camel wool coat',  brand: 'COS',                 cat: 'Outerwear',   season: 'Autumn · Winter', price: 225,  fav: true,  segment: 'owned'    },
  { src: '/seed-wardrobe/cashmere-rollneck-camel.jpg',   name: 'Cashmere rollneck',       brand: 'Pringle of Scotland', cat: 'Tops',        season: 'Autumn · Winter', price: 280,  fav: true,  segment: 'owned'    },
  ...
  { src: '/seed-wardrobe/breton-stripe-tee.jpg',         name: 'Breton stripe tee',       brand: 'Saint James',         cat: 'Tops',        season: 'Spring · Summer', price: 65,   fav: false, segment: 'owned'    },
  ...
  { src: '/seed-wardrobe/penny-loafers-tan.jpg',         name: 'Tan penny loafers',       brand: 'G.H. Bass',           cat: 'Shoes',       season: 'Spring · Autumn', price: 165,  fav: false, segment: 'owned'    },
  ...
  { src: '/seed-wardrobe/quilted-crossbody-black.jpg',   name: 'Quilted crossbody',       brand: 'Polène',              cat: 'Bags',        season: 'All year',        price: 380,  fav: false, segment: 'owned'    },
  { src: '/seed-wardrobe/silk-twill-scarf.jpg',          name: 'Silk twill scarf',        brand: 'Hermès',              cat: 'Accessories', season: 'Spring · Summer', price: 395,  fav: true,  segment: 'owned'    },
  { src: '/seed-wardrobe/gold-layered-necklaces.jpg',    name: 'Gold layered necklaces',  brand: 'Missoma',             cat: 'Jewellery',   season: 'All year',        price: 165,  fav: false, segment: 'owned'    },
  ...
  { src: '/seed-wardrobe/tweed-blazer-ivory.jpg',        name: 'Ivory tweed blazer',      brand: 'Sézane',              cat: 'Outerwear',   season: 'Spring · Autumn', price: 365,  fav: false, segment: 'wishlist' },
  { src: '/seed-wardrobe/lbd-crepe.jpg',                 name: 'Crepe little black dress', brand: 'Roland Mouret',      cat: 'Dresses',     season: 'All year',        price: 595,  fav: false, segment: 'wishlist' },
];
...
const OUTFITS = [
  {
    ...
    items: [
      { slot: 'Top',       name: 'Cashmere rollneck',       src: '/seed-wardrobe/cashmere-rollneck-camel.jpg' },
      { slot: 'Bottom',    name: 'Charcoal wool trouser',   src: '/seed-wardrobe/wool-trouser-charcoal.jpg' },
      { slot: 'Footwear',  name: 'Tan penny loafers',       src: '/seed-wardrobe/penny-loafers-tan.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { slot: 'Outerwear', name: 'Camel wool coat',         src: '/seed-wardrobe/camel-wool-coat.jpg' },
      { slot: 'Footwear',  name: 'Black knee boots',        src: '/seed-wardrobe/leather-knee-boots-black.jpg' },
      { slot: 'Accessory', name: 'Gold layered necklaces',  src: '/seed-wardrobe/gold-layered-necklaces.jpg' },
    ],
  ...
  },
  {
    ...
    items: [
      { slot: 'Top',       name: 'Breton stripe tee',       src: '/seed-wardrobe/breton-stripe-tee.jpg' },
      ...
      { slot: 'Accessory', name: 'Silk twill scarf',        src: '/seed-wardrobe/silk-twill-scarf.jpg' },
    ],
