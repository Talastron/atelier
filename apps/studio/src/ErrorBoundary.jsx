    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center p-6 text-stone-900">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-xs tracking-eyebrow uppercase text-stone-400 mb-3">Atelier</p>
          ...
          {isDev && this.state.error && (
            <pre className="mt-8 text-left text-sm leading-relaxed text-claret-700 bg-white border border-stone-200 rounded-xl p-4 overflow-auto max-h-60 whitespace-pre-wrap">
