                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <span className="text-xs text-stone-400 shrink-0">· {pool.length}</span>
                          {filled.length > 0 && (
                  ...
                  <div className="mb-6 flex flex-col-reverse gap-3 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="shrink-0 self-end sm:self-auto relative inline-flex">
                      ...
                      <select
                        ...
                        className="absolute inset-0 w-full h-full text-base opacity-0 cursor-pointer"
                      >
          ...
          {tab === 'saved' && (activeTagFilter && collectionFilteredOutfits.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                type="button"
                onClick={() => setActiveTagFilter(null)}
                className="mt-3 text-stone-700 underline-offset-4 hover:underline text-xs tracking-wide"
              >
                Show all looks
              </button>
            </div>
            ...
            return (
              <div key={entry.id} className="bg-white border border-stone-200/60 rounded-2xl p-4 sm:p-5 smooth-shadow">
                ...
                {resolvedItems.length > 0 ? (
                  ...
                  <p className="text-sm text-stone-400 italic mb-3">Some items have been deleted from your wardrobe.</p>
                )}
